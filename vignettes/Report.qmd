...
The `show_overall_statistics()` function computes key statistics for attributes such as `id_count`, `item_count`, `resp_count`, and `sparsity`.

Sparsity is calculated using the formula:
